package com.getcloudcherry.survey.customviews;
 ...
 */
public class AutoResizeActionBarTextView extends TextView {
    ...
    public AutoResizeActionBarTextView(Context context) {
        this(context, null);
        applyCustomFont(context);
    }

    // Default constructor when inflating from XML file
    public AutoResizeActionBarTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        applyCustomFont(context);
    }

    // Default constructor override
    public AutoResizeActionBarTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void applyCustomFont(Context context) {
        if (!TextUtils.isEmpty(SurveyCC.getInstance().getHeaderActionBarFontPath())) {
            Typeface customFont = FontCache.getTypeface("fonts/" + SurveyCC.getInstance().getHeaderActionBarFontPath(), context);
