...
public class AutoResizeTextView extends TextView {
    ...
    private void applyCustomFont(Context context) {
        if (!TextUtils.isEmpty(SurveyCC.getInstance().getHeaderFontPath())) {
            Typeface customFont = FontCache.getTypeface("fonts/" + SurveyCC.getInstance().getHeaderFontPath(), context);
